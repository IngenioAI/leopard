            ...
            if detect_results is not None:
                ...
                for frame_align_crop in frame_align_crop_list:
                    ...
                    id_compare_values.append(
                        mse(frame_align_crop_crop_id_nonorm, specific_person_id_nonorm).detach().cpu().numpy())
                ...
                if min_value < id_thres:
                    ...
                    reverse2wholeimage([frame_align_crop_tenor_list[min_index]], [swap_result],
                                       [frame_mat_list[min_index]], crop_size, frame, logoclass, \
