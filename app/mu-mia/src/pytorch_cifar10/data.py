...
class CIFAR10Data(pl.LightningDataModule):
    ...
    def train_dataloader(self, shadow_train=None):
        transform = T.Compose(
            [
        ...
        if shadow_train:
        # shadow train == True // train loader --> test loader
    ...
    def val_dataloader(self, shadow_train=None):
        transform = T.Compose(
            [
                T.ToTensor(),
                T.Normalize(self.mean, self.std),
        ...
        if shadow_train:
        # shadow train == True // test loader --> train loader
            dataloader = DataLoader(
                dataset,
                batch_size=self.hparams.batch_size,
                num_workers=self.hparams.num_workers,
    ...
    def test_dataloader(self, shadow_train=None):
        return self.val_dataloader(shadow_train)
